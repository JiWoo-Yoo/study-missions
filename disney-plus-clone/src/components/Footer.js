...
export default function Footer() {
  return (
    <FooterContainer>
      <FooterContent>
        <FooterLinkContainer>
          <FooterLinkTitle>디즈니+ 대한민국</FooterLinkTitle>
          <FooterLinkContent>
            <FooterLink href="https://help.disneyplus.com/ko/article/disneyplus-introduction">
              디즈니+ 소개
            </FooterLink>
            <FooterLink href="https://help.disneyplus.com/ko/">
              고객센터
            </FooterLink>
